package joazlazer.mods.amc.sevencommons.asm.info;

import joazlazer.mods.amc.sevencommons.asm.ASMUtils;
import joazlazer.mods.amc.sevencommons.asm.MissingClassException;
import joazlazer.mods.amc.sevencommons.internal.exclude.ClassInfoUtil;
...
/**
 * <p>Some information about a class, obtain via {@link ClassInfo#of(String)}, {@link ClassInfo#of(Class)} or {@link ClassInfo#of(ClassNode)}.</p>
 *
 * @author diesieben07
 */
public abstract class ClassInfo extends HasModifiers {
	 ...
	 * @return a ClassInfo
	 * @throws joazlazer.mods.amc.sevencommons.asm.MissingClassException if the class could not be found
	 */
	...
	/**
	 * <p>Determine if the given class can be safely casted to this class (equivalent to {@link Class#isAssignableFrom(Class)}.</p>
