...
import joazlazer.mods.amc.sevencommons.asm.info.ClassInfo;
...
public final class ASMUtils {
	...
	/**
	 * <p>Get the active {@link IClassNameTransformer}, if any.</p>
	 *
	...
	/**
	 * <p>Transform the class name with the current {@link IClassNameTransformer}, if any. Returns the untransformed
	...
	/**
	 * <p>Un-transform the class name with the current {@link IClassNameTransformer}, if any. Returns
	 ...
	 *
	 * @param bytes the class bytes
	 * @param readerFlags the flags to pass to the {@link ClassReader}
	 * @return a ClassNode
	 */
	...
	/**
	 * <p>Checks if the given {@link Type} represents a primitive type or the void type.</p>
	 *
	 * @param type the type
