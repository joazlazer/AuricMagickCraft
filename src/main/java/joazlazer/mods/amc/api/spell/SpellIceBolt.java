...
public class SpellIceBolt extends SpellBase {
    public SpellIceBolt() {
        super();
        setUnlocName("spellIceBolt");
        setTextureLocation(Textures.Spells.ICE_BOLT);
        setLargeTexture(Textures.Spells.ICE_BOLT_LARGE);
        setColor(new Color(210, 245, 245));
    ...
    public void populateTooltip(ArrayList<String> tt) {
        tt.add(GuiColor.MAGENTA + " - Ice Bolt:");
