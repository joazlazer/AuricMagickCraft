...
public class ModOrders {
	...
	public static class ORDERS
	{
		...
		// TODO public static final OrderBase arcana = new OrderArcana();
		// TODO public static final OrderBase alchemia = new OrderAlchemia();
	}
	...
	public static void registerOrders()
	{
		...
		// TODO OrderRegistry.registerOrder(Reference.MOD_ID, ORDERS.arcana);
		// TODO OrderRegistry.registerOrder(Reference.MOD_ID, ORDERS.alchemia);
	}
}
